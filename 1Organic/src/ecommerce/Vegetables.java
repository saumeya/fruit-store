...
public class Vegetables extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Vegetables frmOnlineStore = new Vegetables(def);
	 ...
	 * Create the frame.
	 */
	public Vegetables(int ID) {
		this.ID = ID;
		s = ID;
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 10, 1132, 700);
		contentPane = new VegetablePanel(s,this);
...
class VegetablePanel extends JPanel {

	/**
	 * Create the panel.
	 */
	public VegetablePanel(final int s, final JFrame frame) {
		...
		try {
			...
			JLabel lblNewLabel_4 = new JLabel("Vegetables");
			...
			JButton btnNewButton11 = new JButton("Fruits");
